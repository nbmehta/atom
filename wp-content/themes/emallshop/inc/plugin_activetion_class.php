...
function emallshop_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'             	=> esc_url('http://demo.presslayouts.com/plugins/emallshop/pl-emallshop-extensions-1.1.7.zip'), // The plugin source.
			'version'  				=> '1.1.7',
			'required' 				=> true,
		),
		array(
		...
		array(
			...
			'source'             	=> esc_url('http://demo.presslayouts.com/plugins/Ultimate_VC_Addons.zip'), // The plugin source.
			'version'  				=> '3.16.20',
			'required' 				=> true,
		),
		array(
			...
			'source'             	=> esc_url('http://demo.presslayouts.com/plugins/clever-swatches.zip'), // The plugin source.
			'version'  				=> '2.0.4',
			'required' 				=> false,
		),
		array(
