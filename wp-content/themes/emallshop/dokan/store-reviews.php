    ...
    <div id="dokan-content" class="store-review-wrap woocommerce" role="main">
        ...
        <div id="reviews">
            <div id="comments">
                ...
                <h2 class="headline"><?php _e( 'Seller Review', 'emallshop' ); ?></h2>

                <ol class="commentlist">
                    <?php
                    if ( count( $comments ) == 0 ) {
                        echo '<span colspan="5">' . __( 'No Results Found', 'emallshop' ) . '</span>';
                    } else {
                                            ...
                                            <a href="<?php echo $permalink; ?>">
                                                ...
                                                if ( get_option('woocommerce_enable_review_rating') == 'yes' ) :
                                                    ...
                                                    <div class="dokan-rating">
                                                        <div class="star-rating" title="<?php echo sprintf(__( 'Rated %d out of 5', 'emallshop' ), $rating) ?>">
                                                            <span style="width:<?php echo ( intval( get_comment_meta( $single_comment->comment_ID, 'rating', true ) ) / 5 ) * 100; ?>%"><strong><?php echo $rating; ?></strong> <?php _e( 'out of 5', 'emallshop' ); ?></span>
                                                        </div>
                                                    </div>
                                                <?php endif; ?>
                                            </a>
