...
class RWMB_Sidebars_field extends RWMB_Choice_Field
{
	...
	public static function get_select_all_html( $field )
	{
		...
		{
			return '<div class="rwmb-select-all-none">' . esc_html__( 'Select', 'emallshop' ) . ': <a data-type="all" href="#">' . esc_html__( 'All', 'emallshop' ) . '</a> | <a data-type="none" href="#">' . esc_html__( 'None', 'emallshop' ) . '</a></div>';
		}
		return '';
	}
}
